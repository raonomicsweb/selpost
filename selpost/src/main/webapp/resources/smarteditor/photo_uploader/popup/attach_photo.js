...
//		}
	...
	function generalUpload(){
		...
		var fileInput = document.getElementById('uploadInputBox');
		
		var files = fileInput.files;
		var fileList = fileInput.value;
		console.log("filepath : "+ fileList);
		var filesPath = fileList.split(", ");
		//로컬 방식 크롬은 지원 안됨
		for(var i=0;i<filesPath.length;i++){
			var image = document.createElement("img");
			image.width = 400;
			image.height= 300;
			image.src = filesPath[i];
			var obj = image.outerHTML;
...
//		oFileUploader.upload();
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/admin/file_uploader_html5'; 	//upload URL
